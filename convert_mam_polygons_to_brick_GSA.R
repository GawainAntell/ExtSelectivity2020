...
mam_data <- readOGR("Data/spatial_data/TERRESTRIAL_MAMMALS.shp")
...
sp_nm <- paste0('Data/spatial_data/NAm_mammal_ranges_',grid_res,'degree_any_overlap')
...
sed_nm <- paste0('Data/spatial_data/stage_sediment_',grid_res,'degree_any_overlap')
